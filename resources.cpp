#include "lib/3DTexture.cpp"
#include "lib/Model_3DS.cpp"
...
int in_building_texture1, in_building_texture2, in_building_texture3, out_building_texture1, out_building_texture2, out_building_texture3 ,glass_window_texture2;
...
void loadTextures() {
	...
	//glEnable(GL_TEXTURE_2D);
	wall1 = LoadTexture("data\\billiard.bmp", 255);
	wall2 = LoadTexture("data\\billiard.bmp", 255);
	...
	out_building_texture1 = LoadTexture("data\\out_building_texture1.bmp", 255);
	out_building_texture2 = LoadTexture("data\\out_building_texture2.bmp", 255);
	out_building_texture3 = LoadTexture("data\\out_building_texture3.bmp", 255);
	glass_window_texture2 = LoadTexture("data\\glass_window_texture2.bmp", 55);
...
void loadModels() {
	...
	Table = Model_3DS();
	Table.Load("data\\Table.3dS");
	Table.Materials[1].tex.Load("data\\Dirt bl.bmp");
	Table.Materials[2].tex.Load("data\\2gr.bmp");
	Table.Materials[3].tex.Load("data\\out_building_texture1.bmp");
...
GLfloat LightPos[] = { 100.0f,0.0f,-20.0f,1.0f };
